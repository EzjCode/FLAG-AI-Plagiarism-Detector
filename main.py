...
# Download NLTK data packages if they're not already downloaded
try:
...
text_area = st.text_area("", height=200, max_chars=25000, key="text_input", label_visibility="collapsed")
...
if analyze_button:
    ...
    if not text_to_check.strip():
        ...
        if not check_internet_connection():
            st.error("No internet connection detected. Please check your internet connection and try again.")
        else:
